...
route: ui-blocks
order: 200
summary: A confirmation dialog pattern using native `<dialog>` with title, message, and action buttons.
when_to_use: Destructive or important confirmations using native dialog.
classes:
  - dialog
  - .close
demos:
